...
const theDifference = getTimeDifference(data.createdAt);
  ...
  return (
    <section className="w-full max-w-4xl md:aspect-[10/2.6] aspect-video  sm:aspect-[10/4]  bg-gray-50 drop-shadow-md flex flex-col">
      <main className="flex justify-between  p-5 sm:flex-row w-full flex-col flex-grow">
      ...
      <hr />
      <footer className="h-12  w-full flex justify-between items-center p-3">
